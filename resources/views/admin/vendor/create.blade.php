...
<div class="row mb-3">
    <div class="col-lg-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" id="submitForm" action="{{ route('admin.vendors.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label class="custom-control-label" for="customControlAutosizing">Terms & Condition</label>
                    </div>
                </div>
